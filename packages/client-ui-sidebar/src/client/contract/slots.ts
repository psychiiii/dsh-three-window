...
export type SidebarRootInjected = {
  ...
  /**
   * Whether New Session is a three-window picker. Read at click/render time
   * so a later-mounted workbench is visible.
   */
  windowed?: () => boolean
  /**
   * Create a Session for one workbench pane and bind it there.
  ...
  hooks: {
    ...
    /** Whether New Session is a three-window picker; updates after bind and attach. */
    windowed?: ObservableSnapshot<boolean>
  }
}
