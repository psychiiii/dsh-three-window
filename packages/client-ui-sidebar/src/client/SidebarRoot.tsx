...
import {
  FishLogo, IconNewChatOutlineRegular, IconPanelLeftOutlineRegular, isDarwinDesktop, Tooltip,
      ...
      <div className={css.logoRow}>
        ...
        {wide && (
          <NewSessionControl
            ...
            t={t}
            className={clsx(css.brand, css.wide) as string}
      ...
      <Tooltip label={t('session.new.label')} delayMs={500} disabled={wide}>
        <span>
          <NewSessionControl
            ...
            ariaLabel={t('session.new.label')}
          >
            <IconNewChatOutlineRegular size={wide ? 14 : windowsTitlebar ? 16 : 18} />
